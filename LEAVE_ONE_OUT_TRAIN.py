...
#Import Columns
X_train_sp=Train[:,1:3]    #Colum 1 y 2
Y_train=Train[:,0]  #Colum 0
...
for n_model in range(8):
    ...
    for n_train in  range(54):
        ...
        X_train_LOO = np.delete(X_train, n_train,axis=0)
        Y_train_LOO = np.delete(Y_train, n_train,axis=0)
        
        X_test_LOO = X_train[n_train] 
        Y_test_LOO = Y_train[n_train] 
        
        history = model.fit(X_train_LOO,Y_train_LOO,epochs=200,validation_split = 0.1,verbose=3)
        ...
        X_test_LOO = np.expand_dims(X_test_LOO, axis=0)
        Y_test_LOO = np.expand_dims(Y_test_LOO, axis=0)
        
        predictions = model.predict(X_test_LOO)
        mse = mean_squared_error(Y_test_LOO, predictions)
        print("MSE:", mse)
        mae = mean_absolute_error(Y_test_LOO, predictions)
        print("MAE:", mae)
        ...
        history2 = model2.fit(X_train_LOO,Y_train_LOO,epochs=100,validation_split = 0.1,verbose=3)
        
        predictions = model2.predict(X_test_LOO)
        mse = mean_squared_error(Y_test_LOO, predictions)
        #print("MSE:", mse)
        mae = mean_absolute_error(Y_test_LOO, predictions)
        #print("MAE:", mae)
        ...
        history3 = model3.fit(X_train_LOO,Y_train_LOO,epochs=100,validation_split = 0.1,verbose=3)
        
        predictions = model3.predict(X_test_LOO)
        mse = mean_squared_error(Y_test_LOO, predictions)
        print("MSE:", mse)
        mae = mean_absolute_error(Y_test_LOO, predictions)
        print("MAE:", mae)
